          ...
          <div className="row">
            ...
            <article className="best-post">
              ...
              <div className="best-post-content">
                <div className="best-post-content-cat">April 5, 2023<span className="dot"> </span>Blog</div>
                <div className="best-post-content-title">
                  Decentralized Blogguing!
                </div>
                    ...
                    <div className="post__card_-2">
                      ...
                      <div>
                        <div className="post__card_meta-2">
                          <div className="post__card_cat">April 5, 2023<span className="dot"> </span>{item.account.title} </div>
